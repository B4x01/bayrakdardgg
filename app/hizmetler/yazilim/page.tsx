...
const subServices = [
  {
    ...
    description: 'Tarayıcı tabanlı özel web yazılımları geliştiriyoruz.',
    features: [
      'Kullanıcı dostu arayüzler',
      'Ölçeklenebilir mimari',
      'Güçlü performans',
      'Modern frontend & backend teknolojileri',
    ],
  },
  {
    ...
    icon: Smartphone,
    description:
      'iOS ve Android cihazlar için mobil uygulamalar tasarlayıp geliştiriyoruz.',
    features: [
      'Cross-platform veya native geliştirme',
  ...
  },
  {
    ...
    icon: Code,
    description:
      'Web servisleri ve entegrasyonlar için özel API çözümleri sunuyoruz.',
    features: [
      'RESTful & GraphQL API geliştirme',
      'JWT ve OAuth güvenliği',
  ...
  },
  {
    ...
    icon: Database,
    description:
      'Projeleriniz için güçlü ve güvenilir veritabanı çözümleri sağlıyoruz.',
    features: [
      'Veri modelleme',
      'Yedekleme ve güvenlik',
      'Performans optimizasyonu',
      'SQL & NoSQL destekleri',
    ],
  },
];
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center fade-in-up">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              İhtiyaçlarınıza özel web ve mobil yazılım çözümleri
              geliştiriyoruz.
            </p>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Yazılım geliştirme sürecinde sunduğumuz hizmetler
            </p>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Yazılım geliştirme hizmetimiz hakkında teklif almak için formu
                doldurun.
              </p>
            </div>
            ...
            >
              ...
              <div className="space-y-2">
                <Label htmlFor="website">
                  Mevcut Proje/Platform Linki (varsa)
                </Label>
                <Input
                  id="website"
                  name="website"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Yazılım ihtiyaçlarınızı ve detayları paylaşın"
                  rows={6}
                />
              </div>
