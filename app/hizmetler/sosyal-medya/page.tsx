...
const subServices = [
  {
    ...
    icon: Target,
    description: 'Markanıza özel sosyal medya stratejileri oluşturuyoruz.',
    features: [
      'Hedef kitle analizi',
      'Rakip analizi',
  ...
  },
  {
    ...
    icon: FileText,
    description: 'Marka dilinize uygun içerikler tasarlayıp planlıyoruz.',
    features: [
      'Görsel ve metin üretimi',
      'İçerik planlama ve yayınlama',
      'Özgün post tasarımları',
  ...
  },
  {
    ...
    icon: Users,
    description: 'Hedef kitlenizle etkileşimi artırıyor, güven oluşturuyoruz.',
    features: [
      'Yorum ve mesaj yanıtları',
      'Takipçi etkileşimi',
      'Kriz yönetimi',
      'Topluluk büyütme',
    ],
  },
  {
    ...
    icon: BarChart3,
    description: 'Tüm süreçleri analiz ederek raporluyoruz.',
    features: [
      'Aylık performans raporları',
      'Erişim ve etkileşim analizleri',
      'Strateji optimizasyonu',
      'Hedef bazlı KPI ölçümü',
    ],
  },
];
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center fade-in-up">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Sosyal medya platformlarında markanızı etkin bir şekilde temsil
              ediyoruz.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              {[
                'Özgün Stratejiler',
                'Etkileşim Odaklı İçerik',
                'Raporlama ve Analiz',
                'Güçlü Topluluk Yönetimi',
              ].map((feature, index) => (
                <div
                  key={index}
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Sosyal medya yönetimi kapsamında sunduğumuz hizmetler
            </p>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Sosyal medya yönetimi hizmetimiz hakkında teklif almak için
                formu doldurun.
              </p>
            </div>
            ...
            >
              ...
              <div className="space-y-2">
                <Label htmlFor="website">
                  Web Siteniz veya Sosyal Medya Linki
                </Label>
                <Input
                  id="website"
                  name="website"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Sosyal medya hedeflerinizi ve beklentilerinizi paylaşın"
                  rows={6}
                />
              </div>
